...
describe('Math API - /cinetica', () => {
  ...
  test('velocidadeMedia', async () => {
    ...
    expect(String(res.body.data.resultado)).toContain('10');
  });
  ...
  test('aceleracaoMedia', async () => {
    ...
    expect(typeof res.body.data.resultado).toBe('string');
    expect(String(res.body.data.resultado)).toContain('2');
  });
  ...
  test('mruTest', async () => {
    ...
    // PI radianos == 180 graus
    expect(typeof res.body.data.resultado).toBe('string');
    expect(String(res.body.data.resultado)).toContain('50');
  });
  ...
  test('mruvVel', async () => {
    ...
    // PI radianos == 180 graus
    expect(typeof res.body.data.resultado).toBe('string');
    expect(String(res.body.data.resultado)).toContain('20');
  });
